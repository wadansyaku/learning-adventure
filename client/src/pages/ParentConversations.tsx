...
export default function ParentConversations() {
  ...
  const { data: children, isLoading: childrenLoading } = trpc.parent.getMyChildren.useQuery();
          ...
          <CardContent>
            <select
              ...
              onChange={(e) => {
                ...
                setLocation(`/parent/conversations/${id}`);
              }}
            >
                  ...
                  <div className="space-y-4">
                    {conversationHistory?.map((conv: any) => (
                      <div key={conv.id} className="border-l-4 border-purple-500 pl-4 py-2">
                        ...
                        <div className="mb-2">
                          <span className="font-semibold text-gray-700">お子様: </span>
