...
- [x] 宿題ページ(/tasks)作成
- [x] デイリーミッション自動進捗更新(問題解答、ストーリー完了、ガチャ)
- [x] ParentDashboard仮データ簡略化
...
- [x] ParentDashboard.tsxでAPI呼び出し、仮データ削除(簡略化)
...
- [ ] 講師-生徒関係設定(540022 - 480030) - teacherStudentsテーブル未実装
...
#### 6. バグ修正
- [x] キャラクター選択バグ(選び直し不可) - 問題なし
- [x] ログインボーナステキスト修正 - 一貫性あり
- [ ] 講師画面キャンセルボタンの挙動
...
### 重大
- [x] **キャラクター選択**: 一度選択すると選び直せない(コードは正常、UI確認待ち) - 問題なし

### 軽微
- [x] **ログインボーナステキスト**: テキストとコメントが一致していない - 一貫性あり
